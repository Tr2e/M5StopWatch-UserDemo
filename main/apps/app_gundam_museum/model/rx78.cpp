...
public:
    ...
    void face(Point a,Point b,Point c,Point d,uint16_t color,Point outward,bool insert=false){
        ...
        m.normals[m.count]=n;m.anchors[m.count]=a;m.planeOffsets[m.count]=dot(n,a);m.parts[m.count]=part;// The open palm is assembled from thin fingers; retain both sides of
