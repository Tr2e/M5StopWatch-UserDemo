...
struct SazabiAssembly {
    ...
    std::array<Range,6> funnels{};std::array<Range,2> shoulders{},palms{},containers{},eyeWindow{},wrists{},forearms{};Range shield,rifle,shieldMount,crown,headMount,mask,eyeLens;
