...
void edgeDeviceBenchmark() {
    ...
    unsigned mismatches=0,changedFrames=0;
    ...
    mclog::tagInfo("EdgeAB","END mismatches={} changed={} internal={} psram={} stack_free={}",mismatches,changedFrames,heap_caps_get_free_size(MALLOC_CAP_INTERNAL|MALLOC_CAP_8BIT),heap_caps_get_free_size(MALLOC_CAP_SPIRAM),uxTaskGetStackHighWaterMark(nullptr));
